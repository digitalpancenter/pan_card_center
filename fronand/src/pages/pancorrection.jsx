    ...
    >
       {/* Row 1 */}
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            <input name="pannumber" value={form.pannumber} onChange={handleChange} placeholder="Pan Number" className="border p-2 rounded w-full text-sm placeholder-gray-400" />
        </div>
      {/* Row 2 */}
